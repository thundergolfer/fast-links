# jquery.fastlinksInput

This project is written by [Jonathon Belotti](https://jonathonbelotti.com).

## Introduction
To get started -- checkout http://podio.github.com/jquery-mentions-input (original base for this project)
...
jquery.fastlinksInput is written as a jQuery extension, so it naturally requires jQuery (1.6+). In addition to jQuery, it also depends on underscore.js (1.2+), which is used to simplify stuff a bit.
...
jquery.fastlinksInput has been tested in Firefox 6+, Chrome 15+, and Internet Explorer 8+.
...
## Roadmap
- Fix open issues.
- Seperate fastlinksInput from jQuery, and expose as AMD/CJS module.
