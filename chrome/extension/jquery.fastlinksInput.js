...
(function ($, _, undefined) {
    ...
    //Main class of fastlinksInput plugin
    var fastlinksInput = function (settings) {
        ...
        function initAutocomplete() {
            ...
            if (elmAutocompleteList === 'undefined' ) {
              console.log("elmAutocompleteList is undefined in initAutocomplete()")
            }
        ...
        function initMentionsOverlay() {
            ...
            console.log("elmMentionsOverlay (from initMentionsOverlay()): ")
            console.log(elmMentionsOverlay);
        ...
        function doSearch(query) {
            ...
            if (query && query.length && query.length >= settings.minChars) {
                console.log("Call the onDataRequest function and then call the populateDropDrown");
        ...
        // Public methods
        return {
            //Initializes the fastlinksInput component on a specific element.
    ...
    $.fn.fastlinksInput = function (method, settings) {
        console.log("Hello from inside the fastlinksInput library.");
        var outerArguments = arguments; //Gets the arguments
        console.log("Outer arguments are: ")
        ...
        return this.each(function () {
            var instance = $.data(this, 'fastlinksInput') || $.data(this, 'fastlinksInput', new fastlinksInput(settings));
