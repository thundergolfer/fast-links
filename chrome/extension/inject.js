...
window.addEventListener('load', () => {
  ...
  feature_live_history.platform.reddit = allowedURLs.reddit.test(tab_url);
  feature_live_history.platform.facebook = allowedURLs.facebook.test(tab_url);
  feature_live_history.platform.basic = allowedURLs.github.test(tab_url);
  feature_live_history.run();
  console.log(tab_url);
  /***************************************************************************
